    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-10"><h2><b>Producto</b></h2></div>
                    <div class="col-sm-2">
           ...
           if(isset($_POST) && !empty($_POST)){
	        ...
	        $res = $Productos->createProducto($nombre, $descripcion, $valor, $tienda, $imagen);
	        if($res){
			...
			<div class="row" >
			  <form method="post " enctype="multipart/form-data" >
				...
				<hr>
					<button type="submit" name="save" class="btn btn-success">Guardar datos</button>
				</div>
			  </form>
			</div>
        </div>
